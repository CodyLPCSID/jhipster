...
@NgModule({
    imports: [
        ...
        ProjectJHipsterSharedModule.forRoot(),
        ProjectJHipsterCoreModule,
        ProjectJHipsterHomeModule,
        ProjectJHipsterAccountModule,
